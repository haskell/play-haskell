...
function build_depends_for() {
  ...
  case "$1" in
    ...
    8.6.5)
      ...
      ;;
    9.6.*)
      echo "adjunctions, aeson, array, assoc, async, attoparsec, base, base16, base64, bifunctors, bimap, binary, bitvec, bitwise, BoundedChan, bv-sized, bytebuild, byteslice, bytesmith, bytestring, Cabal, case-insensitive, chronos, clock, colour, comonad, concurrent-extra, config-value, constraints, containers, contiguous, contravariant, copilot-c99 >=3.17, copilot-core >=3.17, copilot-interpreter >=3.17, copilot-prettyprinter >=3.17, data-array-byte, data-default, data-default-class, data-default-instances-containers, data-default-instances-dlist, data-default-instances-old-locale, data-fix, data-reify, deepseq, deriving-compat, directory, distributive, dlist, effectful, effectful-core, exceptions, extra, filepath, fingertree, free, generically, generic-deriving, ghc-boot, ghc-boot-th, ghc-heap, ghci, ghc-prim, hashable, hashtables, haskeline, haskell-src-exts, haskell-src-meta, hpc, ieee754, indexed-traversable, indexed-traversable-instances, integer-gmp, integer-logarithms, invariant, io-streams, kan-extensions, language-c99, language-c99-simple, language-c99-util, lens, libBF, libiserv, linear-base, linear-generics, megaparsec, monad-control, MonadRandom, mtl, natural-arithmetic, old-locale, OneTuple, optparse-applicative, ordered-containers, parallel, parameterized-utils, parsec, parser-combinators, pretty, prettyprinter, primitive, primitive-addr, primitive-offset, primitive-unlifted, process, profunctors, QuickCheck, random, reflection, rts, run-st, safe, safe-exceptions, s-cargot, scientific, semialign, semigroupoids, semigroups, simple-affine-space, splitmix, StateVar, stm, storable-tuple, strict, syb, tagged, template-haskell, temporary, terminfo, text, text-builder-linear, text-short, th-abstraction, these, th-expand-syns, th-lift, th-lift-instances, th-orphans, th-reify-many, time, time-compat, torsor, transformers, transformers-base, transformers-compat, tuples, unbounded-delays, unix, unliftio, unliftio-core, unordered-containers, utf8-string, uuid-types, vector, vector-algorithms, vector-stream, versions, void, what4 >= 1.5, wide-word, witherable, xhtml, xml, zigzag, zlib"
      ;;
    9.8.*)
      echo "adjunctions, aeson, array, assoc, async, attoparsec, base, base64, bifunctors, bimap, binary, bitvec, bitwise, BoundedChan, bytestring, Cabal, case-insensitive, clock, colour, comonad, concurrent-extra, constraints, containers, contravariant, copilot-c99 >=3.17, copilot-core >=3.17, copilot-interpreter >=3.17, copilot-prettyprinter >=3.17, data-array-byte, data-default, data-default-class, data-default-instances-containers, data-default-instances-dlist, data-default-instances-old-locale, data-fix, data-reify, deepseq, deriving-compat, directory, distributive, dlist, effectful, effectful-core, exceptions, extra, filepath, fingertree, free, generically, generic-deriving, ghc-boot, ghc-boot-th, ghc-heap, ghci, ghc-prim, hashable, hashtables, haskeline, haskell-src-exts, haskell-src-meta, hpc, ieee754, indexed-traversable, indexed-traversable-instances, integer-gmp, integer-logarithms, invariant, io-streams, kan-extensions, language-c99, language-c99-simple, language-c99-util, lens, libBF, megaparsec, monad-control, MonadRandom, mtl, natural-arithmetic, old-locale, OneTuple, optparse-applicative, ordered-containers, parallel, parsec, parser-combinators, pretty, prettyprinter, primitive, primitive-addr, primitive-offset, process, profunctors, QuickCheck, random, reflection, rts, safe, safe-exceptions, s-cargot, scientific, semialign, semigroupoids, semigroups, simple-affine-space, splitmix, StateVar, stm, storable-tuple, strict, syb, tagged, template-haskell, temporary, terminfo, text, text-builder-linear, text-short, these, th-expand-syns, th-lift, th-lift-instances, th-orphans, th-reify-many, time, time-compat, torsor, transformers, transformers-base, transformers-compat, tuples, unbounded-delays, unix, unliftio, unliftio-core, unordered-containers, utf8-string, uuid-types, vector, vector-algorithms, vector-stream, void, wide-word, witherable, xhtml, xml, zigzag, zlib"
      ;;
    *)
