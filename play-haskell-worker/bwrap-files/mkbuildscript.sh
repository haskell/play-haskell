...
function build_depends_for() {
  ...
  case "$1" in
    ...
    9.8.*)
      ...
      ;;
    9.10.*)
      echo "adjunctions, aeson, array, assoc, async, attoparsec, base, base64, bifunctors, bimap, binary, bitvec, bitwise, BoundedChan, bytestring, Cabal, case-insensitive, clock, colour, comonad, concurrent-extra, config-value, constraints, containers, contravariant, copilot-core >=3.19, copilot-interpreter >=3.19, copilot-prettyprinter >=3.19, data-array-byte, data-default, data-default-class, data-default-instances-containers, data-default-instances-dlist, data-default-instances-old-locale, data-fix, data-reify, deepseq, deriving-compat, directory, distributive, dlist, effectful, effectful-core, exceptions, extra, filepath, fingertree, free, generically, generic-deriving, ghc-boot, ghc-boot-th, ghc-experimental, ghc-heap, ghc-internal, ghci, ghc-prim, hashable, hashtables, haskeline, haskell-src-exts, haskell-src-meta, hpc, ieee754, indexed-profunctors, indexed-traversable, indexed-traversable-instances, integer-gmp, integer-logarithms, invariant, io-streams, kan-extensions, language-c99, language-c99-simple, language-c99-util, lens, libBF, linear-base, linear-generics, megaparsec, monad-control, MonadRandom, mtl, natural-arithmetic, old-locale, OneTuple, optics, optics-core, optics-extra, optics-th, optparse-applicative, ordered-containers, parallel, parsec, parser-combinators, pretty, pretty-simple, prettyprinter, primitive, primitive-addr, primitive-offset, process, profunctors, QuickCheck, random, reflection, rts, safe, safe-exceptions, s-cargot, scientific, semialign, semigroupoids, semigroups, simple-affine-space, splitmix, StateVar, stm, storable-tuple, strict, syb, tagged, template-haskell, temporary, terminfo, text, text-builder-linear, text-short, th-abstraction, these, th-expand-syns, th-lift, th-lift-instances, th-orphans, th-reify-many, time, time-compat, torsor, transformers, transformers-base, transformers-compat, tuples, unbounded-delays, unix, unliftio, unliftio-core, unordered-containers, utf8-string, uuid-types, vector, vector-algorithms, vector-stream, versions, void, wide-word, witherable, xhtml, xml, Yampa, zigzag, zlib"
      ;;
    9.12.*)
      echo "array, async, base, bimap, binary, bitvec, bitwise, BoundedChan, bytestring, Cabal, case-insensitive, clock, colour, concurrent-extra, containers, contravariant, copilot-core >=3.19, copilot-interpreter >=3.19, copilot-prettyprinter >=3.19, data-array-byte, data-default, data-default-class, data-default-instances-containers, data-default-instances-dlist, data-default-instances-old-locale, data-fix, data-reify, deepseq, deriving-compat, directory, distributive, dlist, dunai >=0.13, effectful, effectful-core, exceptions, extra, filepath, fingertree, generically, generic-deriving, ghc-boot, ghc-boot-th, ghc-experimental, ghc-heap, ghc-internal, ghci, ghc-prim, hashable, hashtables, haskeline, haskell-src-exts, hpc, ieee754, indexed-profunctors, integer-gmp, invariant, language-c99, language-c99-simple, language-c99-util, libBF, monad-control, MonadRandom, mtl, natural-arithmetic, old-locale, optparse-applicative, ordered-containers, parallel, parsec, parser-combinators, pretty, pretty-simple, prettyprinter, primitive, primitive-addr, primitive-offset, process, QuickCheck, random, reflection, rts, safe, safe-exceptions, s-cargot, semigroups, simple-affine-space, splitmix, StateVar, stm, storable-tuple, strict, syb, tagged, template-haskell, temporary, terminfo, text, text-builder-linear, th-abstraction, th-expand-syns, th-lift, th-lift-instances, th-orphans, th-reify-many, time, time-compat, torsor, transformers, transformers-base, transformers-compat, tuples, unbounded-delays, unix, unliftio, unliftio-core, utf8-string, vector, vector-algorithms, vector-stream, void, wide-word, xhtml, xml, Yampa, zigzag, zlib"
      ;;
    *)
