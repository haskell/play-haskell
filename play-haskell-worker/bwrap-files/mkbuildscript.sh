...
function build_depends_for() {
  ...
  case "$1" in
    8.6.5)
      ...
      ;;
    9.6.*)
      echo "adjunctions, aeson, array, assoc, async, attoparsec, base, base16, base64, bifunctors, bimap, binary, bitvec, bitwise, BoundedChan, bv-sized, bytestring, Cabal, case-insensitive, clock, colour, comonad, concurrent-extra, config-value, constraints, containers, contravariant, copilot-c99, copilot-core, copilot-interpreter, copilot-prettyprinter, data-array-byte, data-default, data-default-class, data-default-instances-containers, data-default-instances-dlist, data-default-instances-old-locale, data-fix, data-reify, deepseq, deriving-compat, directory, distributive, dlist, effectful, effectful-core, exceptions, extra, filepath, fingertree, free, generically, generic-deriving, ghc-boot, ghc-boot-th, ghc-heap, ghci, ghc-prim, hashable, hashtables, haskeline, hpc, ieee754, indexed-traversable, indexed-traversable-instances, integer-gmp, integer-logarithms, invariant, io-streams, kan-extensions, language-c99, language-c99-simple, language-c99-util, lens, libBF, libiserv, megaparsec, monad-control, MonadRandom, mtl, old-locale, OneTuple, optparse-applicative, ordered-containers, parallel, parameterized-utils, parsec, parser-combinators, pretty, prettyprinter, primitive, process, profunctors, QuickCheck, random, reflection, rts, safe-exceptions, s-cargot, scientific, semialign, semigroupoids, semigroups, simple-affine-space, splitmix, StateVar, stm, strict, tagged, template-haskell, temporary, terminfo, text, text-short, th-abstraction, these, th-lift, th-lift-instances, time, time-compat, transformers, transformers-base, transformers-compat, unbounded-delays, unix, unliftio, unliftio-core, unordered-containers, utf8-string, uuid-types, vector, vector-algorithms, vector-stream, versions, void, what4 >= 1.5, witherable, xhtml, xml, Yampa, zlib, linear-base, storable-tuple, text-builder-linear"
      ;;
    9.8.*)
      echo "storable-tuple, text-builder-linear, adjunctions, array, assoc, async, attoparsec, base, bifunctors, bimap, binary, bitvec, bitwise, BoundedChan, bytestring, Cabal, case-insensitive, clock, colour, comonad, concurrent-extra, constraints, containers, contravariant, copilot-c99, copilot-core, copilot-interpreter, copilot-prettyprinter, data-default, data-default-class, data-default-instances-containers, data-default-instances-dlist, data-default-instances-old-locale, data-fix, data-reify, deepseq, deriving-compat, directory, distributive, dlist, effectful, effectful-core, exceptions, extra, filepath, fingertree, free, generically, generic-deriving, ghc-boot, ghc-boot-th, ghc-heap, ghci, ghc-prim, hashable, hashtables, haskeline, hpc, ieee754, indexed-traversable, indexed-traversable-instances, integer-gmp, integer-logarithms, invariant, io-streams, kan-extensions, language-c99, language-c99-simple, language-c99-util, lens, libBF, monad-control, MonadRandom, mtl, old-locale, OneTuple, optparse-applicative, ordered-containers, parallel, parsec, parser-combinators, pretty, prettyprinter, primitive, process, profunctors, QuickCheck, random, reflection, rts, s-cargot, scientific, semialign, semigroupoids, semigroups, simple-affine-space, splitmix, StateVar, stm, strict, tagged, template-haskell, temporary, terminfo, text, text-short, th-abstraction, these, th-lift, th-lift-instances, time, time-compat, transformers, transformers-base, transformers-compat, unbounded-delays, unix, unliftio, unliftio-core, unordered-containers, utf8-string, uuid-types, vector, vector-algorithms, vector-stream, void, witherable, xhtml, xml, zlib"
      ;;
    *)
