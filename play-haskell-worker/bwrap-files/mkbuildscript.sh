...
function build_depends_for() {
  ...
  case "$1" in
    ...
    9.8.*)
      ...
      ;;
    9.10.*)
      echo "array, assoc, async, attoparsec, base, bimap, binary, bitvec, bitwise, BoundedChan, bytestring, Cabal, case-insensitive, clock, colour, concurrent-extra, containers, contravariant, copilot-core >=3.19, copilot-interpreter >=3.19, copilot-prettyprinter >=3.19, data-array-byte, data-default, data-default-class, data-default-instances-containers, data-default-instances-dlist, data-default-instances-old-locale, data-fix, data-reify, deepseq, deriving-compat, directory, distributive, dlist, effectful, effectful-core, exceptions, extra, filepath, fingertree, generic-deriving, ghc-boot, ghc-boot-th, ghc-experimental, ghc-heap, ghc-internal, ghci, ghc-prim, hashtables, haskeline, haskell-src-exts, hpc, ieee754, integer-gmp, integer-logarithms, invariant, io-streams, language-c99, language-c99-simple, language-c99-util, libBF, monad-control, MonadRandom, mtl, natural-arithmetic, old-locale, OneTuple, optparse-applicative, parallel, parsec, parser-combinators, pretty, prettyprinter, primitive, primitive-addr, primitive-offset, process, QuickCheck, random, reflection, rts, safe, safe-exceptions, s-cargot, semigroups, simple-affine-space, splitmix, StateVar, stm, storable-tuple, strict, syb, tagged, template-haskell, temporary, terminfo, text, text-builder-linear, text-short, th-abstraction, th-expand-syns, th-lift, th-lift-instances, th-orphans, th-reify-many, time, time-compat, torsor, transformers, transformers-base, transformers-compat, tuples, unbounded-delays, unix, utf8-string, vector, vector-algorithms, vector-stream, void, xhtml, xml, Yampa, zigzag, zlib"
      ;;
    *)
